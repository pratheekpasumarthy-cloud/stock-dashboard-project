...
def generate_signal(avg_return, volatility):
...
def main():
    ...
    revenue = st.sidebar.number_input('Revenue (M)', 100000.0)
    ...
    col3.metric('Price', f"${data['Close'].iloc[-1]:.2f}")
    ...
    year5_income = proj['Net Income (M)'].iloc[-1]
